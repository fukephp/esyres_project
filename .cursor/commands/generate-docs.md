...
2. Decide whether the change belongs in `docs/mvp/` (product scope), `docs/architecture/` (stack, data, Docker), `docs/stories/`, `docs/tasks/`, `docs/diagrams/`, or `README.md` (repo status / how to run).
3. Update existing files in place. Do not add new doc files unless the user asked, or the existing sets are the wrong place.
