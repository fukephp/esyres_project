...
Do not invent product scope, architecture, or application code. After a successful copy, tell the user to open the new folder as the workspace and run grill-me.
