...
Do not invent product scope, architecture, or application code. After a successful copy, tell the user to open the new folder as the workspace and run grilling / `/grill-me` (product grill persist writes mvp + `docs/stories/STORY-xx.md`).
