...
**Owner onboarding:** public. A signed-in user may create a salon (ADR 0026). Customer register is public and does not create a salon. Email verify still gates `/owner`.
