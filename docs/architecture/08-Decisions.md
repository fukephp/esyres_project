...
7. **Public salon register** — a signed-in user may create a salon; invite-only founder provision is revoked. Same users table. See `docs/adr/0026-public-salon-register.md`. Local demo seed (STORY-38) still provisions known logins; it is not the only way to own a salon.
