...
- `/owner` — owner: inbox, worker panel (home), in-flight chat tab (`/owner/chats`, list only), settings, stats; **salon switcher** when the user owns more than one salon
