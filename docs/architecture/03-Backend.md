...
- Reminder scan: scheduled `bookings:send-reminders` (not delayed jobs on confirm). Stamps `reminder_day_sent_at` / `reminder_hour_sent_at`. See `docs/adr/0017-reminder-scan-not-delayed-jobs.md`.
