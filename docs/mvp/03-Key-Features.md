...
- **Salon edit** — `/owner/salons/:id`: name, address (cannot blank), full weekly hours (days, times, optional break, cancel window), create/edit services and workers by name. No delete. No worker↔service matrix. DND stays on chats. Photos, coordinates, and reschedule cap stay off this page.
