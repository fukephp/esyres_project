...
- **Discovery home** — `/salons`; no login required; geolocation-based "salons near you," falling back to "Popular in Sarajevo"; search/filter by service type and name. Only **listed** salons (one open weekday and one service). Brand in the top-nav links home.
