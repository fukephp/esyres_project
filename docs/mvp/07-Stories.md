...
**Inventory for what-next / story-loop is `docs/stories/` (`STORY-01` … `STORY-43`), not this file.** Acceptance criteria live only on those story files. This page stays the narrative source those files were split from.
